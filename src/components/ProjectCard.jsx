...
const ProjectCard = ({ title, description, techStack, liveLink, githubLink }) => {
  return (
    <div className="max-w-sm rounded overflow-hidden shadow-lg bg-gray-900  transition duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-2xl">
